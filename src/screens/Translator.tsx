...
export interface TranslatorProps {
  /** Saqlangan gaplar — App'da turadi, ikkala rejim ham shunga yozadi */
  saved: Entry[];
  setSaved: (next: Entry[] | ((prev: Entry[]) => Entry[])) => void;
  isSaved: (ru: string) => boolean;
  toggleSave: (ru: string, uz: string) => void;
}

export function Translator({ saved, setSaved, isSaved, toggleSave }: TranslatorProps) {
